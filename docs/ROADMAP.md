...
- [x] Inject relevant memories into the LLM context
...
- [x] Add `save_memory` as the third safe MVP tool
- [x] Let the LLM select registered tools automatically
- [x] Add long-term memory storage
...
- [x] Capture microphone input through replaceable adapter
